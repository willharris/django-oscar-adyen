    ...
    def _unpack_details(self, details):
        ...
        if Constants.MERCHANT_RETURN_DATA in details.keys():
            ...
            if '~' in return_data:
                ...
                merchant_return_data = parse.unquote_plus(user_data)
                if six.PY2:
                    merchant_return_data = merchant_return_data.decode('utf8')
                unpacked_details['merchant_return_data'] = merchant_return_data
            else:
